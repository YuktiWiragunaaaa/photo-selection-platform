    ...
    <AdminShell eyebrow="Sesi baru" title="Buat galeri untuk klien">
      <form onSubmit={submit} className="max-w-xl space-y-10">
        ...
        <div>
          ...
          <p className="mt-2 text-xs text-mute">Kalau diisi, tombol “Kirim lewat WhatsApp” langsung membuka chat klien ini.</p>
        </div>
        ...
        <div className="grid grid-cols-2 gap-6">
          <div>
            ...
            <div className="flex items-end gap-2">
              <input autoComplete="off" id="pin" inputMode="numeric" pattern="[0-9]{4}" maxLength={4} className="field font-mono text-lg tracking-[0.3em]" value={form.pin} onChange={(e) => setForm((f) => ({ ...f, pin: e.target.value.replace(/\D/g, '') }))} placeholder="4 digit" />
